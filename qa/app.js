...
window.exportarExpediente = function(codigo, btnEl) {
  ...
  .then(function(d){
    ...
    htm+='</style></head><body>';
    htm+='<div class="print-toolbar"><span>Vista imprimible con texto seleccionable. En Chrome/Edge usa destino "Guardar como PDF"; evita "Microsoft Print to PDF" si necesitas copiar o extraer texto.</span><div class="print-toolbar-actions"><label><input type="checkbox" onchange="document.body.classList.toggle(&quot;print-source&quot;, this.checked)">Incluir fuente QA</label><button onclick="window.print()">Guardar como PDF</button></div></div>';
